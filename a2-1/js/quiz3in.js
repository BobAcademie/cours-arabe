...
const scrambleData = {
  "scramble-1": {
    ...
    words: ["عِيدٌ", "سَعِيدٌ", "عِمادُ", "يا"], // Les mots individuels
  },
};
...
const oddOneOutData = {
  ...
  "nature-2": {
    instruction: "بِماذا يَحْتَفٍلُ عِمادٌ؟ ",
    options: [
      {
        text: "بِعيدِ الْفِطْرِ ",
      ...
      {
        text: "بِعيدِ مِيلادِهِ ",
        audio: "../sounds/9af/classe.mp3",
        correct: true,
      }, // Orange
      {
        text: "بِالعَوْدَةِ إلَى الْمَدْرَسَةِ",

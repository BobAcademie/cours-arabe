...
const oddOneOutData = {
  "fatima-comprehension-1": {
    instruction: "ماذا كانت فاطمة تفعل في المطبخ؟",
    options: [
      { text: "كانت تلعب", correct: false },
      { text: "كانت تقطع الطماطم والبطاطس", correct: true }, // Utilise vos mots clés
      { text: "كانت تشاهد التلفاز", correct: false },
      { text: "كانت تكتب واجبها", correct: false },
    ],
  },
  "fatima-comprehension-2": {
    instruction: "ماذا قررت الأم أن تُعِدَّ للغداء؟",
    options: [
      { text: "حساء الخضر", correct: false },
      { text: "سلطة", correct: false },
      { text: "طاجين باللحم والخضر", correct: true },
      { text: "أرز بالدجاج", correct: false },
    ],
  },
};
...
const puzzleData = {
  "Ta2-puzzle-1": {
    instruction: "Reconstitue le mot (Avion)",
    word: "طَائِـرَةٌ",
    letters: ["ةٌ", "رَ", "ئِـ", "طَا"],
  },
};
